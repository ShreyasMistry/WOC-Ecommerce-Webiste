...
<table width="500" align="center">
	...
	<tr>
		<td align="right">Enter Curretn Password :</td>
		<td><input type="password" name="old_pass" class="textbox" required /></td>
	</tr>

	<tr>
		<td align="right">Enter New Password:</td>
		<td><input type="password" name="new_pass" class="textbox" required /></td>
	</tr>

	<tr>
		<td align="right">Enter New Password Again:</td>
		<td><input type="password" name="new_pass_again" class="textbox" required /></td>
	</tr>
	<tr>
